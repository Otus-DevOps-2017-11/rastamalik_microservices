...
```
6. Проверил что поды запустились ``` kubectl get pods --all-namespaces ```
7.Задание со звездочкой.
8.Создал папку **ansible** куда поместил основные плэйбуки и bash скрипты для разворачивания **kubernetes-кластера**. Для удобства  и пошаговой установки создал **Makefile** где описал все шаги разворачивания.
